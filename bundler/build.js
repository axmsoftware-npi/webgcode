({
    out: "webGcodeWidget.bundle.js",
    baseUrl: "../webapp",
    optimize: "uglify", //"none ",
    name: "webGcodeWidget/main",
    include: [
        "libs/ace/src-noconflict/theme-chaos", 
    ],
    paths: {
    ...
    shim: {
        ...
        "libs/threejs/OrbitControls": {
            deps: ["THREE"],
            exports: "THREE.OrbitControls"
        },
        "libs/threejs/TrackballControls": {
            deps: ["THREE"],
            exports: "THREE.TrackballControls"
        },
        "libs/threejs/CSS3DRenderer": {
            deps: ["THREE"],
            exports: "THREE.CSS3DRenderer"
        },
        "libs/threejs/STLLoader": {
            deps: ["THREE"],
            exports: "THREE.STLLoader"
        },
        "libs/threejs/SubdivisionModifier": {
            deps: ["THREE"],
            exports: "THREE.SubdivisionModier"
        },
        "libs/threejs/postprocessing/EffectComposer": {
            deps: ["THREE",
        ...
        "libs/threejs/postprocessing/RenderPass": {
            deps: ["THREE"],
        ...
        "libs/svg-import": {
            deps: ["libs/svg", "libs/svg-parser"]
        },
        "libs/svg.draggable": {
            deps: ["libs/svg", "libs/svg.draggable"]
        },
        RSVP: {
            exports: "RSVP"
        },
