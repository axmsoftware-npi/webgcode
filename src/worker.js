...
importScripts('bundle/require.min.js');
importScripts('bundle/webGcodeWidget.worker.bundle.js');
var tasks = {
    ...
    acceptProgram: function (event) {
        require(['cnc/gcode/parser', 'cnc/gcode/simulation', 'cnc/util'], function (parser, simulation, util) {
